- dashboard: billing
  ...
  - title: Total Billing Last Month
    ...
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: budget, label: Budget, expression: '390000',
  ...
  - title: Billing by Project
    ...
    explore: gcp_billing_export
    type: looker_column
    fields: [gcp_billing_export_project.name, gcp_billing_export.total_cost, gcp_billing_export.usage_start_date]
    pivots: [gcp_billing_export_project.name]
    fill_fields: [gcp_billing_export.usage_start_date]
    filters:
      gcp_billing_export.usage_start_date: 30 days
    sorts: [gcp_billing_export.total_cost desc 0, gcp_billing_export_project.name]
    limit: 500
    column_limit: 50
    stacking: normal
  ...
  - title: Billing by Service
    ...
    filters:
      gcp_billing_export.usage_start_date: 30 days
    sorts: [gcp_billing_export.total_cost desc 0, gcp_billing_export_service.description]
    limit: 500
    column_limit: 50
    stacking: percent
    show_value_labels: false
  ...
  - title: Predicted Total Monthly Costs
    ...
    dynamic_fields: [{table_calculation: x_bar, label: x_bar, expression: 'mean(${gcp_billing_export.total_cost})',
      ...
      {table_calculation: total_cost, label: Total cost, expression: 'sum(${gcp_billing_export.total_cost})',
        ...
        value_format_name: usd_0, _kind_hint: dimension, _type_hint: number}]
    custom_color_enabled: false
    custom_color: forestgreen
    show_single_value_title: true
    show_comparison: false
